    ...
    stocks: {
      'modifier stock': {
        page: {
          ...
          desc: 'Modifier le stock de produits en magasin'
        }
      },
      'ajouter article': {
        page: {
          title: 'Ajouter Stock',
          desc: 'Ajouter des produits au stock en magasin'
        }
      }
    },
    produits: {
      page: {
        title: 'Produits',
        desc: 'Tous les produits enregistes dans le stock et leurs details'
      },
    },
    configuration: {
      page: {
        title: 'Configuration',
        desc: 'Reglage de l\'application'
      },
    },
    ngbootstrap: {
      accordion: {
